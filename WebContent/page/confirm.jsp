    	...
    	<div class="contentCenter">
    		<div class="centerTop">
    			...
    			<p style="font-size:15px;">
					收件人姓名：<input type="text" id='addName' disabled  name="name" value="${sessionScope.customer.name }"><br/><br/>
					收件人地址：<input type="text" id='addAdd' disabled  name="address"  value="${sessionScope.customer.address }" ><br/><br/>
					收件人电话：<input type="text" id='addPhone' disabled  name="telephone" value="${sessionScope.customer.telephone }" >
				</p>
    				...
    				<c:forEach items="${sessionScope.car.lines }" var="line">
    					<ul class="oneUL">
    						<li>
    							...
    							<p>计算机&nbsp;&nbsp;JAVA&nbsp;&nbsp;${line.book.name }&nbsp;&nbsp;</p>
    							<p><font>¥${line.book.price*line.num }</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${line.num }&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;有货</p>
    		...
    		<div class="money">
    			<span><font>${sessionScope.car.count }</font>件商品，总商品金额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥${sessionScope.car.total }</span>
    			<span><img src="images/sureLogo_18.png" alt="">运费：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥0.00</span>
    			
    			<span>应付总额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥${sessionScope.car.total }</span>
    		</div>
    		<div class="submit">
    			<span>应付金额：<font>¥${sessionScope.car.total }</font><a href="toConfirmSucServlet"><img src="images/21_03.png" alt=""></a></span>
    		</div>
    	</div>
