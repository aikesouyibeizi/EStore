...
<body>
    ...
    <div class="header3">
    	...
    	<div class="h3_center">
            ...
            <p>
            	<a href="listServlet?id=1">文学类</a>|
            	<a href="listServlet?id=2">教育类</a>|
                <a href="listServlet?id=3">计算机</a>|
                <a href="listServlet?id=4">儿童类</a>|
                <a href="listServlet?id=5">漫画类</a>|
            </p>
        </div>
        <div class="h3_right">
        	<div class="myyy">
            	<a href="page/userinfo.jsp">个人信息</a>
                <span class="sj_down"></span>
             </div>
            <div class="tsc">
            	<a href="users/toShopCarServlet">去购物车结算</a>
            ...
            <div class="cn5_top_y center01">
                ...
                <div class="cn5topy_2">
                    ...
                    <div class="pro_buy">
                        ...
                        <div class="pro_addshop"> <a href="users/addShopCartServlet?id=${requestScope.book.id }&num=1" >加入购物车 </a></div>
                    </div>
