...
<body>
	...
	<div class="header3">
		...
		<div class="h3_center">
			...
			<p>
				<a href="listServlet?id=1">文学类</a>| <a href="listServlet?id=2">教育类</a>| <a
					href="listServlet?id=3">计算机</a>| <a href="listServlet?id=4">儿童类</a>| <a
					href="listServlet?id=5">漫画类</a>|
			</p>
		</div>
		<div class="h3_right">
			<div class="myyy">
	...
	<div class="nav_top">
		<div class="nav_top_center">
			...
			<ul>
				...
				<li><a href="listServlet?id=6">工具类</a></li>
				<li><a href="listServlet?id=7">期刊类</a></li>
			</ul>
		</div>
	</div>
	...
	<div class="container4">
		...
		<div class="c4_b1">
			<ul class="c4_b1_boxes">
				<c:forEach items="${requestScope.category.books }" var="book">
		...
		<div class="c4_b2">
			<h1 class="c4_b2_x">
				<a href="#">${requestScope.category.name }&nbsp;&nbsp;></a> <span><a
					href="#">${requestScope.category.name }</a></span>
			</h1>
						...
						<li class="c4_b5_c_box">
							...
							<div class="c4_b5_c_box_pic">
								<div class="c4b5_pic_view">
									<a href="viewBookServlet?id=${book.id }"><img src="images/list_p1.png"></a>
								</div>
							</div> <!--价钱-->
							...
							<ul class="c4b5_option">
								<li class="shopcar_box"><span class="shopcar01"></span><a
									href="users/addShopCartServlet?id=${book.id }&num=1" >加入购物车
								</a></li>
							</ul>
						</li>
					</c:forEach>
